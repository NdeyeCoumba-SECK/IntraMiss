...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gm.stats_handler' => 'getGm_StatsHandlerService',
            'gm_requete' => 'getGmRequeteService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UtilisateursBundle\Form\Type\ProfileType A UtilisateursBundle\Form\Type\ProfileType instance
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \UtilisateursBundle\Form\Type\ProfileType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UtilisateursBundle\Form\Type\RegistrationType A UtilisateursBundle\Form\Type\RegistrationType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \UtilisateursBundle\Form\Type\RegistrationType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gestionmissions', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\UtilisateursBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\GM\\ProjetBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'UtilisateursBundle\\Entity');
        $c->addDriver($b, 'GM\\ProjetBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UtilisateursBundle' => 'UtilisateursBundle\\Entity', 'GMProjetBundle' => 'GM\\ProjetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cd1179c772b00690dd6f8c7a04ed1456bb82a927f7a9b6ce1ab46f5a0bf64a40');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('UtilisateursBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'UtilisateursBundle\\Form\\Type\\ProfileType', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('UtilisateursBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'UtilisateursBundle\\Form\\Type\\RegistrationType', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('UtilisateursBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('UtilisateursBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'UtilisateursBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'gm.stats_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \GM\GestionDepensesBundle\Stats\StatsHandler A GM\GestionDepensesBundle\Stats\StatsHandler instance
     */
    protected function getGm_StatsHandlerService()
    {
        return $this->services['gm.stats_handler'] = new \GM\GestionDepensesBundle\Stats\StatsHandler($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'gm_requete' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \GM\ProjetBundle\Service\Requete A GM\ProjetBundle\Service\Requete instance
     */
    protected function getGmRequeteService()
    {
        return $this->services['gm_requete'] = new \GM\ProjetBundle\Service\Requete($this->get('doctrine.dbal.default_connection'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $o->setOptions(array('failure_path' => NULL, 'login_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $l, 'main', $n, $o, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '586e50c1cd4094.50307721', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GM\\ProjetBundle/Resources/views'), 'GMProjet');
        $instance->addPath(($this->targetDirs[3].'\\src\\RessourceBundle/Resources/views'), 'Ressource');
        $instance->addPath(($this->targetDirs[3].'\\app/Resources/FOSUserBundle/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\GM\\GestionDepensesBundle/Resources/views'), 'GMGestionDepenses');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('65d51013772f0ff04d82b2a2c9d1513e0b1b224e');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ATOS' => array(0 => 'ROLE_USER'), 'ROLE_COLAB' => array(0 => 'ROLE_USER'), 'ROLE_ARH' => array(0 => 'ROLE_USER'), 'ROLE_DRH' => array(0 => 'ROLE_USER'), 'ROLE_DG' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GMProjetBundle' => 'GM\\ProjetBundle\\GMProjetBundle',
                'RessourceBundle' => 'RessourceBundle\\RessourceBundle',
                'LiuggioExcelBundle' => 'Liuggio\\ExcelBundle\\LiuggioExcelBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'GMGestionDepensesBundle' => 'GM\\GestionDepensesBundle\\GMGestionDepensesBundle',
            ...
            'secret' => '65d51013772f0ff04d82b2a2c9d1513e0b1b224e',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '65d51013772f0ff04d82b2a2c9d1513e0b1b224e',
            ...
            'fos_user.model.user.class' => 'UtilisateursBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'UtilisateursBundle\\Form\\Type\\ProfileType',
            ...
            'fos_user.registration.form.type' => 'UtilisateursBundle\\Form\\Type\\RegistrationType',
