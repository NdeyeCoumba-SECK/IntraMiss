...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/GM')) {
            // gm_gestiondepenses_default_index
            if ($pathinfo === '/GM/index') {
                return array (  '_controller' => 'GM\\GestionDepensesBundle\\Controller\\DefaultController::indexAction',  '_route' => 'gm_gestiondepenses_default_index',);
            }

            // gm_gestiondepenses_default_depenses
            if ($pathinfo === '/GM/depenses') {
                return array (  '_controller' => 'GM\\GestionDepensesBundle\\Controller\\DefaultController::depensesAction',  '_route' => 'gm_gestiondepenses_default_depenses',);
            }
        ...
        if (0 === strpos($pathinfo, '/GM')) {
            ...
            if (0 === strpos($pathinfo, '/GM/excel')) {
                ...
                // gm_projet_update_date
                if ($pathinfo === '/GM/excel') {
                    return array (  '_controller' => 'GM\\ProjetBundle\\Controller\\DsmsController::dateAction',  '_route' => 'gm_projet_update_date',);
                }
            ...
            // gm_projet_dsms_perdiem
            if ($pathinfo === '/GM/perdiem') {
                return array (  '_controller' => 'GM\\ProjetBundle\\Controller\\DsmsController::perdiemAction',  '_route' => 'gm_projet_dsms_perdiem',);
            }

            if (0 === strpos($pathinfo, '/GM/export')) {
                // gm_projet_dsms_perdiem_export
                if ($pathinfo === '/GM/exportPerdiem') {
                    return array (  '_controller' => 'GM\\ProjetBundle\\Controller\\DsmsController::exportPerdiemAction',  '_route' => 'gm_projet_dsms_perdiem_export',);
                }

                // gm_projet_dsms_perdiem_export_tout
                if ($pathinfo === '/GM/exportToutPerdiem') {
                    return array (  '_controller' => 'GM\\ProjetBundle\\Controller\\DsmsController::exportToutPerdiemAction',  '_route' => 'gm_projet_dsms_perdiem_export_tout',);
                }
